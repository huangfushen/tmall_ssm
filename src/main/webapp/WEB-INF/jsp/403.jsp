...
<head>
    ...
    <style>
        ...
        body h1 span:nth-of-type(1) {
            ...
            -webkit-animation-duration: 0.66667;
            animation-duration: 0.66667;
        }
        ...
        body h1 span:nth-of-type(2):before, body h1 span:nth-of-type(2):after {
            content: "0";
            position: absolute;
            top: -15vmin;
            left: 0;
        ...
        body .chain:nth-of-type(1):before, body .chain:nth-of-type(1):after {
        ...
        body .chain:nth-of-type(2):before, body .chain:nth-of-type(2):after {
        ...
        body .chain:nth-of-type(3):before, body .chain:nth-of-type(3):after {
        ...
        body .chain:nth-of-type(4):before, body .chain:nth-of-type(4):after {
        ...
        body .chain:nth-of-type(5):before, body .chain:nth-of-type(5):after {
        ...
        body .chain:nth-of-type(6):before, body .chain:nth-of-type(6):after {
        ...
        body .chain:before, body .chain:after {
            content: "";
            position: absolute;
            width: 100%;
            height: 100%;
